...
public class SessionlessForm<T> extends StatelessForm<T> {
	...
	private String recode(String s) {
		String enc = Application.get().getRequestCycleSettings().getResponseRequestEncoding();
		String un = UrlDecoder.QUERY_INSTANCE.decode(s,enc);		
